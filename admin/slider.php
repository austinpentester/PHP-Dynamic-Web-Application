...
if (isset($_POST['delete_id'])) {
    ...
    $sql = "DELETE FROM slider WHERE id = $delete_id";
...
// Assuming you have established a database connection and have a valid $conn variable
...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['submit']) && $_POST['submit'] == 'submit') {
    ...
    $stmt = $conn->prepare("UPDATE slider SET heading = ?, image = ? WHERE id = 8");
    $stmt->bind_param("ss", $heading, $photo);
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Index Message </h5>
                            <form method="post" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="name">Heading</label>
                                    <input type="text" class="form-control" id="name" value="<?php echo $heading ?>" name="heading" required>
                                </div>
                                <div class="form-group">
                                ...
                                <input type="hidden" name="old_photo" value="<?php echo $image; ?>">
